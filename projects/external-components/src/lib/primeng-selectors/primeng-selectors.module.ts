import { TestELCComponent } from './components/TestELC-external/TestELC-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TestELCComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TestELCComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
